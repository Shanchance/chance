...
<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/bas/line/form?id=${line.id}">产线${not empty line.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="line" action="${ctx}/bas/line/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">所属车间:</label>
			<div class="controls">
					<form:select path="workshop.id" id="workshop.id" class="input-medium required" >
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="lineDescription" htmlEscape="false" maxlength="50" />
			</div>
		</div>
