...
<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/bas/workShop/form?id=${workShop.id}">车间${not empty workShop.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="workShop" action="${ctx}/bas/workShop/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">所属工厂:</label>
			<div class="controls">
					<form:select path="factory.id" id="factory.id" class="input-medium required" >
